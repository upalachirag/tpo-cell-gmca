...
const EditCompany = () => {
    ...
    const handleSubmit = (event) => {
        ...
        axios.put('http://localhost:8081/admin/EditCompany/'+id, { Name, Description, Technology, Location })
            .then(res => {
                ...
                <div id="page-inner">
                    <div className="row">
                        <div className="col-md-12">
                            <h1 className="page-head-line">Update Company</h1>
                                ...
                                <div className="panel panel-primary">
                                    ...
                                    <div className="panel-body">
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <div className="form-group">
                                                <label className='btn-info'>Update photo from "Gallery" section</label>
                                            </div>
